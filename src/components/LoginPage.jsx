  ...
  return (
    <div className="flex min-h-screen justify-center w-screen xl:max-w-[1440px] xl:mx-auto xl:items-center">
      <div className="relative flex flex-col xl:flex-row w-full ">
        ...
        {/* leftside */}
        <div
          className="relative bg-custom bg-custom-pos xl:m-2.5 w-full xl:w-602px xl:h-[870px] h-[135px] md:h-[296px] rounded-none xl:rounded-md bg-no-repeat bg-cover xl:p-46px md:p-23px"
        >
          <div className="absolute inset-0 bg-black opacity-50 rounded-none xl:rounded-md"></div>
          <img
            src={logo}
            alt="Example"
            className="absolute w-221.91px h-49.63px top-16 left-1/2 transform -translate-x-1/2 md:top-20px md:left-119px xl:top-43px xl:left-156px"
          />
          <div className="hidden md:block absolute md:border-[0px] xl:border-1px md:px-0 md:py-0 xl:py-26px xl:pl-26px xl:pr-100px  border-gray-100/45 xl:w-510px h-[324px] rounded-10px top-[102px] xl:top-295px">
            <div className="md:block flex flex-col justify-center text-white md:w-384px ">
          ...
          {/* <div className="hidden md:block absolute md:top-102px xl:top-314px xl:left-71px md:w-384px flex flex-col justify-center text-white">
          ...
          <div className="hidden md:block xl:hidden absolute bottom-23px right-23px">
            <Icons />
          </div>

          <div className="hidden xl:block">
            <div className="xl:w-510px absolute flex justify-between mx-auto md:top-262px xl:top-814px">
              <Icons />
        ...
        {/* rightside */}
        <div className="flex flex-col p-4 mt-4 w-full md:w-500px mx-auto xl:mt-283px xl:p-0">
          ...
          <form>
            <div className="mb-4">
              <div className="relative mb-4">
                <input
                  placeholder=" "
                  type="text"
                  className="w-full md:w-466px h-10 peer placeholder-transparent text-black border border-gray-300 py-2 px-3 text-sm font-normal focus:border-blue-500 focus:outline-none transition-colors duration-150"
                />
              ...
              <div className="flex items-center justify-between mt-4 md:w-466px">
            ...
            <button
              type="submit"
              className="w-full md:w-466px h-10 bg-[#1F87C9] text-white rounded mt-4"
            >
              Sign In
            </button>
          </form>
          <div className="mt-50px md:mt-314px">
            <div className="xl:w-510px flex flex-col md:top-262px xl:top-814px">
              <p className="block xl:hidden text-black text-center font-sans text-15px font-400 leading-20px">
                © Copyright NEXTPORT - All Rights Reserved
              </p>
              <div className="mx-auto md:hidden mt-10px ">
                <Icons />
              </div>
            </div>
          </div>
        </div>
        <div className='absolute xl:w-259px h-[36px] flex justify-between  md:gap-[12px] top-[15px] right-[12px] md:top-[31px] md:right-[26px]  xl:top-[19px] xl:right-[26px]  '>
          <h2 className='hidden md:block w-147.31px font-sans font-[100] text-[15px] md:text-white xl:text-black leading-[20.43px] mt-[7px] '>Don’t have an account?</h2>
